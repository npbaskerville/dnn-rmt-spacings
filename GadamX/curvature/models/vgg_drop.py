...
# The VGG_Drop-16 model for Backpack - added by Xingchen Wan 30 Nov 2019
...
def get_backpacked_VGG_Drop(model: VGG_Drop, depth=6, batch_norm=False, num_classes=10, cuda=True):
