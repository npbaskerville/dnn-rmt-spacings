...
from .shakeshake_utils import get_alpha_beta, shake_function

__all__ = ['ShakeShake32', 'ShakeShake64']
...
class ShakeShake(nn.Module):
    def __init__(self, input_shape, num_classes, base_channels, depth,
                 shake_forward=True, shake_backward=True, shake_image=True, ):
        ...
        #                      config['shake_image'])
        self.shake_config = (shake_forward, shake_backward, shake_image)
...
class ShakeShake64:
    """Make 2x ResNet 64 networks with ShakeShake Regularisation"""
    base = ShakeShake
    args = []
    kwargs = {'depth': 26,
              'base_channels': 64,
...
class ShakeShake32:
    """Make 2x ResNet 32 networks with ShakeShake Regularisation"""
    base = ShakeShake
    args = []
    kwargs = {'depth': 26,
              'base_channels': 32,
